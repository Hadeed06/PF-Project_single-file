...
int main()
{
	string T1[11]{ "Hadeed Rauf" ,"Ammar" , "Ali" ,"Muneeb" ,"Huzaima" ,"Ahmed" ,"Sohail" ,"Farzeen" ,"mubeen" ,"Alyan" ,"Qasim" };
	...
	int over;
	fstream m_file;
	m_file.open("configration.txt", ios::in);
	if (!m_file)
	{
	...
	else
	{
		while (1)
		{
			...
			cout << "Overs are  :" << over << endl << endl;
			cout << "Per bowler can bowled  :" << over / 5 << "  overs " << endl;
